...
public class CustomerAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tvInfo = (TextView) rowView.findViewById(R.id.textViewInfo);
        ImageView ivImp = (ImageView) rowView.findViewById(R.id.imageViewmovie);

        // Obtain the to-do item based on the 'position'.
        movie currentItem = alMovies.get(position);
        ...
        if(currentItem.getRated().equalsIgnoreCase("g")){
            ivImp.setImageResource(R.drawable.rating_g);
        }else if(currentItem.getRated().equalsIgnoreCase("pg")){
            ivImp.setImageResource(R.drawable.rating_pg);
